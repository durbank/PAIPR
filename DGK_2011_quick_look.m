...
filename=struct('name', {'radar_20111218_03234255_0069.dat',...
    'radar_20111218_03255663_0070.dat', 'radar_20111218_03281080_0071.dat'});
...
for i1 = 1:length(filename)
    tic
    file_path = strcat(radar_dir, filename(i1).name);
    fid = fopen(file_path,'r','ieee-be');
